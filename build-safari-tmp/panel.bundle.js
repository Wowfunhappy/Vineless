(function () {
    ...
    async function setIcon(filename, tabId = undefined) {
    ...
    async function openPopup(url, width, height) {
        const options = { url };
    ...
    function notifyUser(title, message, noConsoleLog) {
        if (!noConsoleLog) {
